<?php
/*
	File name: test_getallclasses.php
	Version:   2.1.2
	
	Description:
	test_getallclasses.php tests whether the getallclasses function is 
	working correctly.
*/
...
*/
	require '../taxon/getallclasses.php';
	...
	$result = getallclasses("$taxonomies_dir/$taxonomy" . ".json");
