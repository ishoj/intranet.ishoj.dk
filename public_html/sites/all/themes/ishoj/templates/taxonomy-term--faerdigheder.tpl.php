  ...
  $output .= "<section id=\"taxonomy-term-" . $term->tid . "\" class=\"" . $classes . " artikel\">";
    $output .= "<div class=\"container\">";
      ...
      $output .= "<div class=\"row second\">";
        $output .= "<div class=\"grid-two-thirds\">";
          $output .= "<h1>Færdigheder: " . $term_name . "</h1>";
        $output .= "</div>";
      ...
      $output .= "<div class=\"row second\">";
        $output .= "<div class=\"grid-two-thirds\">";
          ...
          // INDHOLD 
          $output .= vis_bruger_profiler('færdigheder', $term->tid); // Parametre, der kan anvendes: 'ansvarsområder', 'afdeling', 'stilling', 'færdigheder'  
