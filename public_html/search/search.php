          ...
          $data_stringmed = '{
            "query": {
              "bool": {
                ...
                "must": {
                  "match": {
                    "field_ansvarsomraader:name": "' . $arr[1] . '"
                  }
                }
              }
            },
            ...
            "query": {
              "bool": {
                ...
                "must":[{
                  "query_string":{
                    "query":"' . $arr[1] . '*",
                    "fields":["field_ansvarsomraader:name"]
                  }
                }]
              }
            }
          ...
          "query":{
            "bool":{
              "should":[{
                "query_string":{
                  "query":"*' . $query . '*",
                  "fields":["field_faerdigheder:name"]
                }
              }]
            }
          }
