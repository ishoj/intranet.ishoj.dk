...
*/
 ...
 //  {"bool":{"should":[{"query_string":{"query":"*jesper*","fields":["_all"]}}]}}
     ...
     $data_stringmed = '{"query":{"function_score":{"functions":[],"query":{"bool":{"should":[{"query_string":{"query":"' . $query . '*","fields":["field_fornavn"]}},{"query_string":{"query":"*' . $query . '*","fields":["_all"]}}]}}}}, "sort": { "field_kaldenavn": { "order": "asc" }},"size":3000}';  
...
$jsontest = json_decode($json2, true);
if ($jsontest['hits']['total'] == 0) {
$json2 = searchmedarb('{"query":{"function_score":{"functions":[],"query":{"bool":{"should":[{"query_string":{"query":"' . $query . '*","fields":["field_fornavn"]}}]}}}}, "sort": { "field_kaldenavn": { "order": "asc" }},"size":3000}');
} 
